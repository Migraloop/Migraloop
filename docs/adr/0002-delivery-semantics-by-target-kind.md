...
Operator-facing document-vs-relational ownership rules live in the handbook:

- [Target System — Managed Columns / fields](../../handbook/en/target-system.md#managed-columns--fields)
