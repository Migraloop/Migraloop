...
use migraloop_capture::{
    alignment_check_read_for_source, classify_schema_impact, load_injected_schema_changes,
    normalize_change_temporals, AlignmentCheckSample, CapturePosition, ChangeEvent, ChangeOp,
    PipelineSchemaDeps, SchemaChangeEvent, SchemaImpact, SourceColumn,
};
...
use migraloop_platform_store::{
    ...
    replace_base_dataset, replace_derived_dataset, set_pipeline_paused,
    ...
    Pipeline, PlatformStore, PlatformStoreHealth, QuarantinedChange, SchemaChangeImpact,
    SystemConnection,
};
use migraloop_runtime::{
    ...
    ensure_store_session_healthy, identity_key, load_secondary_bases_and_columns_for_pipeline,
    mongo_target_from_deployment, open_deployment_incremental_capture, oracle_source_connect,
    output_identity_from_row, persist_maintenance_state_json, pipeline_base_table_refs,
    pipeline_has_target, pipeline_references_table, resolve_secret_value,
    source_columns_for_pipeline, source_timezone_opt, target_document_identity_key,
    transform_ops_from_pipeline,
};
use migraloop_transform::{
    analyze_affect_on_base_with_bases, analyze_affect_with_maintenance,
